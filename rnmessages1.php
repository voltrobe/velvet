...
style='height:auto;width:90%;margin:0px 50px 20px 50px;padding:-60px;top:0px;'> ";
...
<p style='margin-left:5px;'><b class='defb'>Type here to leave a wALL Message: </b><br />
<textarea name='text' cols='70' rows='8'></textarea><br />
Public<input type='radio' name='pm' value='0' checked='checked' />
Private<input type='radio'  name='pm' value='1' />
<input type='submit' class='button green' value='Post Message' />
<button id='refresh'><a href='rnmessages1.php'>Refersh</a></button>
</p></form>
</fieldset>
</td>
