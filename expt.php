...
<div class="st-content-inner">
		<div class="container">
			...
			<header>
				<h1 id='lodda'>Nifty Modal Window Effects <span>Some inspiration for different modal window appearances</span></h1>
			</header>
			...
			<!--</div>  -->
			<a  href='#lodda' rel='facybox' id='example1'>LoddaTerra</a>
		<div class="main clearfix">
							<div id="st-trigger-effects" class="column">
		<button data-effect='st-effect-11'>sidebar Slip Up</button>
		</div></div>
		</div><!-- /container -->
		</div></div> <!--Inner-content ,and content -->
