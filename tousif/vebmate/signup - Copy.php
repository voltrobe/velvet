   ...
   <section id="register">
      ...
      <div>
         ...
         <div >
            ...
            <!-- form -->
            <form style="margin:-20px 20px 20px 20px" id="reg" name="reg" id="RegisterForm" method="post" onsubmit="return submit();" action="Register.php">
					<fieldset>
...
<label>Gender  <span class="required">*</span></label>
					<select class="select" id="day" name="Day" style="width: 90px; height: 30px" onchange="checkdob(this.value)">
                  ...
                  <div style="margin:20px 0 0 0">
                     <input id="submit" type="submit" style="width:300px;" value="Register"></div>
					</fieldset>
				</form> <!-- Form End -->
<p style="margin-left:20px">By clicking register, you confirm that you have read and you agree our 
...
// do error checking
if (ret == false){
document.getElementById('validationresult').innerHTML = "<b class='errorbox'>There were errors in the form submitted by you. Please correct them.</b>";
...
$('#usn').blur(function()
		{
			...
			if(usn.value=="")
			{
				document.getElementById('usncheck').innerHTML = "<b class='error'>USN is required.</b>";
			}
			else if(pos)
...
"onlyUSN": {
                    "regex": /^[1-4][a-zA-Z][a-zA-Z]\d{2}[a-zA-Z][a-zA-Z]\d{3}$/,
                    "alertText": "* Invalid USN"
                },
                */
</script>
</body>
